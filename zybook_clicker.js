...
const clicker = className => () => Object.values(document.getElementsByClassName(className)).forEach(x => x.click());

// Check all 2x Speed boxes
Object.values(document.getElementsByClassName("zb-checkbox")) // Get all checkbox divs
  .filter(d => Object.values(d.children) // Filter them...
    .some(t => t.innerText === "2x speed")) // ...such that the div is for a 2x speed checkbox
